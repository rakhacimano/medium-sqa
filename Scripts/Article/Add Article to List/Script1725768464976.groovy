...
WebUI.click(findTestObject('Object Repository/Page_Medium/svg_Jan 14_bk'))

WebUI.click(findTestObject('Object Repository/Page_Medium/svg_See all (2)_mc'))

WebUI.click(findTestObject('Object Repository/Page_Medium/div_Reading listUIUXUIUXCreate new list'))
...
WebUI.click(findTestObject('Object Repository/Page_Your library/a_Reading list_be ap bf bn bh as bi ac at a_537381'))
