...
WebUI.click(findTestObject('Object Repository/Page_Rakha Putra Pratama  Medium/a_Edit profile'))

WebUI.setText(findTestObject('Object Repository/Page_Settings - Medium/textarea_boy'), 'boy')

WebUI.click(findTestObject('Object Repository/Page_Settings - Medium/button_Save'))
