...
WebUI.click(findTestObject('Object Repository/Page_Medium/a_Whats new in Flutter 3.24Unleashing Flutt_f7866d'))

WebUI.click(findTestObject('Object Repository/Page_Whats new in Flutter 3.24. Unleashing _f6966c/svg_Aug 7, 2024_yx'))

WebUI.setText(findTestObject('Page_Prompting Is Dead DSPy For Prompting  AIGuys/p_What are your thoughts'), 'yes')

WebUI.click(findTestObject('Object Repository/Page_Whats new in Flutter 3.24. Unleashing _f6966c/button_Respond'))

WebUI.click(findTestObject('Object Repository/Page_Whats new in Flutter 3.24. Unleashing _f6966c/div_yes'))
