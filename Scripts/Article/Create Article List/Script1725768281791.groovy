...
WebUI.click(findTestObject('Object Repository/Page_Medium/div_Library'))

WebUI.click(findTestObject('Object Repository/Page_Your library/button_New list'))

WebUI.click(findTestObject('Object Repository/Page_Your library/h2_Create new list'))

WebUI.setText(findTestObject('Object Repository/Page_Your library/input_Create new list_wx bh bf bi wy wz xa _e93dd3'), 
    'UI/UX')

WebUI.click(findTestObject('Object Repository/Page_Your library/button_Create'))

WebUI.click(findTestObject('Object Repository/Page_List UIUX  Curated by Rakha Putra Prat_8f7ab1/div_Write_eh by l bz ca ei n ay ej'))

WebUI.click(findTestObject('Object Repository/Page_List UIUX  Curated by Rakha Putra Prat_8f7ab1/div_Library'))
